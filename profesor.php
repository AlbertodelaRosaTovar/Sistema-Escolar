...
if (isset($_POST['enviar'])) {
	...
	if (!empty($nempleado) && !empty($nombre)) {
		//Insertar datos en la tabla de la db  
		$sql = $cnnPDO->prepare("INSERT INTO profesoress
                (nempleado, nombre) VALUES (:nempleado, :nombre )");

		//Asignar las variables a los campos de la tabla
		$sql->bindParam(':nempleado', $nempleado);
			...
			<div class="col-6 offset-3">
				<div class="form">
					...
					<form class="login-form" method="POST">
						<input type="text" placeholder="Numero de empleado" name="nempleado">
